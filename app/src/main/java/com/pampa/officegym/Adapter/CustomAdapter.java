...
public class CustomAdapter extends BaseAdapter {
    ...
    public CustomAdapter(Context context, ArrayList<Ejercicio> ejercicios){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imagen = (ImageView) convertView.findViewById(R.id.ImageEjercicio);
        imagen.setImageResource(R.drawable.plancha);
        return convertView;
    }
